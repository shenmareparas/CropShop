...
// general images
  ...
  // Banners
  static String banner1 = "$bannersImagesPath/banner1.jpeg";
  static String banner2 = "$bannersImagesPath/banner2.jpeg";
  // Categories path
  ...
  static String seeds = "$categoriesImagesPath/seeds.png";
}
